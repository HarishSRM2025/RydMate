...
// const Navbar1 = () => {
//   return (
//     <div className="container-fluid bg-white py-5 border-bottom shadow-sm">
//       <div className="row align-items-center text-center text-md-start px-4">
...
const Navbar1 = () => {
  ...
  useEffect(() => {
    // Trigger collapse after 3s on first visit (mobile only)
